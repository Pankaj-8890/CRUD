...
clean: clean_greet clean_calculator clean_Book ## Clean generated files
	${RM_F_CMD} ssl/*.crt
	${RM_F_CMD} ssl/*.csr
	${RM_F_CMD} ssl/*.key
	${RM_F_CMD} ssl/*.pem
...
clean_Book: ## Clean generated files for Book
	${RM_F_CMD} Book/${PROTO_DIR}/*.pb.go
